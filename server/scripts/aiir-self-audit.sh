...
check_file "${ROOT}/docs/AI2AI_HANDOFF.md"
...
check_file "${ROOT}/server/scripts/aiir-heuristics-refresh.sh"
...
check_pattern "${ROOT}/docs/AI2AI_HANDOFF.md" "Heuristics Sync" "handoff_has_heuristics_sync"
...
check_pattern "${ROOT}/server/scripts/aiir" "^  heuristics\\)" "cli_has_heuristics"
...
check_pattern "${ROOT}/ai/exchange/build-package.run.sh" "has_heuristics" "build_has_heuristics_sync"
check_pattern "${ROOT}/ai/exchange/unpack-package.run.sh" "heuristics-sync-ok" "unpack_has_heuristics_sync"
