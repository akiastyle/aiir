...
Last run (UTC): `2026-03-12T08:00:02Z`
...
| `https://github.com/TanStack/query.git` | `fe25edc` | 42.45 | 4.41 | 89.62% | 100.00% | 8 (2 custom) | 8 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/chartjs/Chart.js.git` | `a153556` | 28.36 | 2.11 | 92.55% | 100.00% | 8 (2 custom) | 8 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
...
| `https://github.com/olifolkerd/tabulator.git` | `fe38eb7` | 30.94 | 1.81 | 94.14% | 100.00% | 7 (1 custom) | 7 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/vuejs/core.git` | `cea3cf7` | 7.52 | 4.33 | 42.38% | 100.00% | 8 (2 custom) | 8 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
...
| `https://github.com/tailwindlabs/tailwindcss.git` | `bf2e2fe` | 6.02 | 3.50 | 41.94% | 100.00% | 8 (2 custom) | 8 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/vercel/swr.git` | `5fa2952` | 1.34 | 0.87 | 34.86% | 100.00% | 8 (2 custom) | 8 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/vitest-dev/vitest.git` | `b0b83e2` | 51.92 | 5.11 | 90.16% | 100.00% | 9 (3 custom) | 9 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/facebook/react.git` | `4610359` | 45.38 | 22.08 | 51.34% | 100.00% | 8 (2 custom) | 8 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
...
| `https://github.com/alpinejs/alpine.git` | `1735d0b` | 6.96 | 1.30 | 81.31% | 100.00% | 6 (0 custom) | 6 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
...
| `https://github.com/nestjs/nest.git` | `b3767bf` | 6.66 | 3.69 | 44.55% | 100.00% | 8 (2 custom) | 8 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/pmndrs/zustand.git` | `a3869ca` | 2.71 | 0.46 | 83.14% | 100.00% | 8 (2 custom) | 8 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/remix-run/react-router.git` | `00cb4d7` | 11.78 | 6.93 | 41.15% | 100.00% | 8 (2 custom) | 8 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/tailwindlabs/tailwindcss.git` | `ad9fdef` | 6.07 | 3.51 | 42.22% | 100.00% | 7 (1 custom) | 7 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/vuejs/core.git` | `fdd863f` | 7.54 | 4.35 | 42.33% | 100.00% | 8 (2 custom) | 8 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/webpack/webpack.git` | `d5fc9c6` | 40.83 | 9.55 | 76.62% | 100.00% | 8 (2 custom) | 8 (+0) | 100.00% | 100.00% | 100.00% | none | ok |

Artifact delta (latest per repo+commit): paiir_custom_added_total=113 oaiir_new_added_total=0 repos_with_custom_paiir=63/64 repos_with_oaiir_new=0/64 parity_below_100=0/64 ok=64/64 chunked=0 skipped_large=0
