...
Last run (UTC): `2026-03-06T08:12:00Z`

Base package overhead excluded from AIIR net size: 0.00 MB (2281 bytes)
Full analysis threshold (convert+parity): 350 MB source size
...
Summary (latest per repo+commit): reduction_avg=65.49% overall_parity_avg_ok=100.00% ok=15/20 skipped_large=5
