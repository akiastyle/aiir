...
Last run (UTC): `2026-03-06T10:56:31Z`
...
| `https://github.com/angular/angular.git` | `d69c468` | 159.59 | 42.21 | 73.55% | 100.00% | 9 (3 custom) | 9 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/axios/axios.git` | `84285c8` | 2.19 | 0.66 | 69.72% | 100.00% | 8 (2 custom) | 8 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/django/django.git` | `23931eb` | 56.76 | 18.78 | 66.92% | 100.00% | 9 (3 custom) | 9 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
...
| `https://github.com/fastify/fastify.git` | `b61c362` | 3.35 | 2.05 | 38.81% | 100.00% | 8 (2 custom) | 8 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/gin-gonic/gin.git` | `3e44fdc` | 1.14 | 0.67 | 41.56% | 100.00% | 7 (1 custom) | 7 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
...
| `https://github.com/laravel/framework.git` | `cf4df18` | 30.92 | 15.27 | 50.62% | 100.00% | 11 (5 custom) | 11 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/nestjs/nest.git` | `0b99623` | 6.66 | 3.69 | 44.56% | 100.00% | 8 (2 custom) | 8 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
...
| `https://github.com/rails/rails.git` | `074429b` | 42.38 | 18.73 | 55.80% | 100.00% | 10 (4 custom) | 10 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/sveltejs/kit.git` | `56fa4fa` | 9.50 | 2.51 | 73.56% | 100.00% | 8 (2 custom) | 8 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
| `https://github.com/symfony/symfony.git` | `d5721a3` | 107.15 | 84.05 | 21.56% | 100.00% | 7 (1 custom) | 7 (+0) | 100.00% | 100.00% | 100.00% | none | ok |
...
Summary (latest per repo+commit): reduction_avg=58.55% overall_parity_avg_effective=100.00% paiir_avg=8.00 oaiir_avg=8.00 ok=20/20 chunked=0 skipped_large=0
